...
#Responsetype (count, habitat, density)
#ROI: (bf, hab) specifies region of interest to gather density estimates from, bankful (bf) area or only within suitable habitat (hab)
#areas? default is bf.

responsedensity=function(GUTdir,layer="Tier2_InChannel_Transition", response="NREI", ROI="bf", Responsetype="density") {     #, selectionfilepath=NA, idcolname="Visit", RScolname="RS"){ #I need to add capability of summarizing layers with or without transition.
